...
class DeepSeekAdapter(BaseAdapter):
    ...
    def translate_request(self, normalized_request: NormalizedRequest,
        ...
        # DeepSeek follows OpenAI schema closely
        return {
            "model": model_name,
            "messages": [
    ...
    def translate_response(self, raw_response: dict,
        ...
        try:
            # DeepSeek follows OpenAI response structure
            ...
            return NormalizedResponse(
                ...
                contract_errors=[f"Failed to extract content from DeepSeek response: {e}"]
            )
    ...
    def send(self, normalized_request: NormalizedRequest,
        ...
        try:
            ...
            if response.status_code != 200:
                return None, response.status_code, f"DeepSeek API error: {response.text[:200]}"
